...
if __name__ == "__main__":
    ...
    indian_cities_plot = altair_chart(indian_cities_plot_data, color_column="region", stroke_dash="transportation_type")
    ...
    if city == "All":
        ...
        indian_city_plot = altair_chart(indian_cities_plot_data[indian_cities_plot_data["region"] == city], stroke_dash="transportation_type")
